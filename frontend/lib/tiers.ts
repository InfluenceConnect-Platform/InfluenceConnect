...
export const BRAND_TIERS: TierDef[] = [
  {
    ...
    tagline: 'Run your first campaigns',
    features: [
      '3 active campaigns',
      'Creator discovery — 5 profiles/day',
      'Accept & reject applications',
      'Campaign performance dashboard',
      '5 messages per day',
      'File sharing up to 10 MB',
      'Email notifications',
    ],
  },
  {
...
export const INFLUENCER_TIERS: TierDef[] = [
  {
    key: 'free', label: 'Free', priceMonthly: 0,
    tagline: 'Start collaborating with brands',
    features: [
  ...
  },
  {
    ...
    tagline: 'For creators building momentum',
    features: [
      'Everything in Free, plus:',
  ...
  },
  {
    ...
    tagline: 'For creators earning consistently',
    features: [
      'Everything in Silver, plus:',
  ...
  },
  {
    ...
    tagline: 'No limits, for full-time creators',
    features: [
