          ...
          <div className="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-5">
            ...
            <div className="flex flex-col sm:items-end gap-2 flex-shrink-0">
              <Link
                ...
                className="inline-flex items-center gap-2 bg-white text-[#3D5087] hover:bg-blue-50 px-5 py-2.5 rounded-xl text-sm font-bold transition-all shadow-sm self-start sm:self-auto"
              >
