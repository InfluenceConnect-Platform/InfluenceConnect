  ...
  return (
    <div className="min-h-screen bg-[#F4F6FB]">
      ...
      <main className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
        ...
        {/* ── Hero ── */}
        <section className="relative bg-gradient-to-br from-[#03050f] via-[#3346d9] to-[#7c8aff] rounded-2xl px-6 sm:px-10 py-7 sm:py-9 mb-6 overflow-hidden shadow-lg">
          {/* decorative blobs */}
        ...
        <section className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-5">
          ...
          <div className="flex flex-col gap-4">
            ...
            {/* Upgrade card */}
            {!isPremium ? (
              <div className="relative bg-gradient-to-br from-[#03050f] via-[#3346d9] to-[#7c8aff] rounded-2xl p-5 overflow-hidden shadow-md">
