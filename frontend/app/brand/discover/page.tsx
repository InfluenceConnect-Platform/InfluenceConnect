  ...
  return (
    <div className="min-h-screen bg-[#F4F6FB]">
      ...
      <main className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
        ...
        {/* Hero banner */}
        <section className="relative overflow-hidden bg-gradient-to-br from-[#03050f] via-[#3346d9] to-[#7c8aff] rounded-2xl px-6 sm:px-10 py-8 sm:py-10 mb-5 shadow-lg">
            ...
            {loading ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4">
                {influencers.map((influencer, i) => {
                  ...
                  const bannerGrad = 'from-[#03050f] via-[#3346d9] to-[#7c8aff]';
                  return (
                    <div
                      key={i}
