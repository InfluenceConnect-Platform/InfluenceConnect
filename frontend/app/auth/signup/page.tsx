      ...
      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
        ...
        <div className="hidden lg:flex flex-col">
          ...
          <div className="grid grid-cols-3 gap-3">
            {STATS.map((s, i) => (
              <div key={i} className={`p-4 border rounded-2xl text-center ${s.color}`}>
        ...
        <div className="rounded-2xl overflow-hidden shadow-[0_4px_6px_rgba(0,0,0,0.04),0_12px_32px_rgba(0,0,0,0.08),0_32px_64px_rgba(127,168,173,0.12)] border border-gray-200/80">
          ...
          <div className="bg-white px-8 pt-7 pb-8">
            ...
            <h2 className="text-[1.65rem] font-bold text-gray-900 mb-1 tracking-tight">Create your account</h2>
                ...
                return (
                  <button
                    ...
                    className={`p-3.5 rounded-xl border-2 text-left transition-all duration-200 cursor-pointer ${
                      isActive
                        ? `bg-gradient-to-br ${ROLE_META[r].gradient} border-transparent shadow-md`
                        : 'border-gray-200 hover:border-gray-300 bg-white hover:shadow-sm'
                    }`}
                  >
                    <div className="flex items-center gap-2 mb-1">
                      <div className={`w-6 h-6 rounded-lg flex items-center justify-center flex-shrink-0 ${isActive ? 'bg-white/20' : 'bg-gray-100'}`}>
            ...
            {error && (
              <div className="mt-3 p-3.5 bg-red-50 border border-red-100 rounded-xl text-sm text-red-600 flex items-start gap-2.5">
            ...
            {/* Bot protection */}
            <div className="mt-4 p-3 bg-gray-50 border border-dashed border-gray-200 rounded-xl flex items-center gap-3 text-sm text-gray-500">
              <div className="w-5 h-5 rounded-md bg-gradient-to-br from-emerald-500 to-green-600 flex items-center justify-center flex-shrink-0">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2.5 px-4 py-3 border border-gray-200 rounded-xl text-sm font-semibold text-gray-700 bg-white hover:bg-gray-50 hover:border-gray-300 hover:shadow-sm transition-all duration-150 cursor-pointer"
            >
