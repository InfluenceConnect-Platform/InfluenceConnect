        ...
        {freeTrialAvailable && (
          <div className="mb-8 relative overflow-hidden bg-gradient-to-r from-amber-400 via-amber-300 to-yellow-300 rounded-2xl p-5 sm:p-6 shadow-lg flex flex-col sm:flex-row sm:items-center gap-4">
            ...
            <div className="flex-1 min-w-0">
              <h2 className="text-base font-bold text-[#4A3800]">Welcome perk: your first month of any paid plan is free</h2>
        ...
        <div className="flex justify-center mb-6">
          <div className="inline-flex items-start gap-2.5 px-4 py-3 rounded-2xl border bg-white dark:bg-[#0f1e31] border-gray-200 dark:border-slate-700/60 shadow-sm max-w-xl">
            ...
            <p className="text-[12px] text-gray-600 dark:text-slate-300 leading-relaxed">
              ...
              You&apos;ll be charged each {billing === 'monthly' ? 'month' : 'year'}{' '}
              until you cancel. Cancel any time from this page — you keep access until the end of the period you&apos;ve paid for.
            </p>
          </div>
        </div>
                ...
                <div className="bg-white dark:bg-[#0E1B2E] px-5 py-5 flex-1 flex flex-col">
                  {isCurrent ? (
                    ...
                    <button
                      ...
                      className="w-full py-2.5 bg-gradient-to-r from-amber-400 to-yellow-400 hover:from-amber-500 hover:to-yellow-500 text-[#4A3800] rounded-xl text-xs font-bold transition-all duration-200 disabled:opacity-60 flex items-center justify-center gap-1.5 mb-5 shadow-md cursor-pointer"
                    >
                      {claimingTrial === t.key ? (
                        <span className="w-3.5 h-3.5 border-2 border-[#4A3800]/40 border-t-[#4A3800] rounded-full animate-spin" />
                      ) : (
                        <><SparkIcon /> Try free · 30 days</>
                      )}
                    </button>
                  ) : (
                    <button
