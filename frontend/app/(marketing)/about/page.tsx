...
export default function AboutPage() {
  return (
    <>
      {/* Hero */}
      <section className="relative overflow-hidden bg-gradient-to-br from-[#FCE4EC] via-white to-[#EAF7EA] dark:from-[#3D0A20]/60 dark:via-[#0E1B2E] dark:to-[#14531D]/50">
        <div aria-hidden className="anim-blob absolute -top-24 -right-24 w-[26rem] h-[26rem] rounded-full bg-[#228B22]/15 blur-3xl" />
        ...
        <div className="anim-fade-up relative max-w-3xl mx-auto px-5 sm:px-8 pt-16 pb-16 lg:pt-24 text-center">
          <span className="inline-block text-[0.7rem] font-bold uppercase tracking-[0.18em] text-[#E0115F] mb-4">
            About us
          </span>
          <h1 className="text-4xl sm:text-5xl font-bold leading-[1.12] tracking-tight text-gray-900 mb-6">
            Making influencer marketing{' '}
            <span className="bg-[linear-gradient(90deg,#E0115F,#3A3A45_50%,#228B22)] bg-clip-text text-transparent">
              work for everyone
            </span>
          </h1>
      ...
      <div className="relative max-w-3xl mx-auto px-5 sm:px-8 pt-12 pb-16 sm:pt-16">
        <Reveal>
        <div className="relative overflow-hidden bg-gradient-to-br from-white via-white to-[#F0417B]/[0.05] dark:from-[#0E1B2E] dark:via-[#0E1B2E] border border-gray-200 rounded-3xl p-8 sm:p-10 shadow-sm hover:shadow-lg transition-shadow duration-300">
          <span aria-hidden className="absolute inset-x-0 top-0 h-1.5 bg-[linear-gradient(90deg,#E0115F,#3A3A45_33%,#228B22_55%,#EA580C)]" />
      ...
      <section className="max-w-5xl mx-auto px-5 sm:px-8 py-20">
        <Reveal>
        <div className="relative overflow-hidden rounded-3xl bg-[linear-gradient(135deg,#7A0F3D,#3A3A45_50%,#14531D)] px-8 py-14 sm:px-14 text-center shadow-2xl">
