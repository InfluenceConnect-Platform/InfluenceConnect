  ...
  return (
    <>
      ...
      <div className="relative max-w-5xl mx-auto px-5 sm:px-8 pt-2 pb-20">
        ...
        {/* Quick pointers */}
        <div className="mt-10 bg-gradient-to-br from-[#EEF4F5]/60 via-white to-[#F5F3FF]/50 border border-gray-200 rounded-2xl p-7 sm:p-8 dark:from-[#0d2d33]/50 dark:via-[#0E1B2E] dark:to-[#2c1f4d]/40">
