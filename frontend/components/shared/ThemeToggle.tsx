  ...
  return (
    <button
      ...
      className={`relative w-9 h-9 flex items-center justify-center rounded-xl border transition-all duration-200 cursor-pointer overflow-hidden shadow-sm flex-shrink-0
        ${isDark
          ? 'border-slate-700 bg-slate-800/80 text-slate-400 hover:text-slate-200 hover:bg-slate-700/60 hover:border-slate-600'
    ...
    >
      ...
      <svg
        ...
        className={`absolute w-[17px] h-[17px] transition-all duration-300 ${
