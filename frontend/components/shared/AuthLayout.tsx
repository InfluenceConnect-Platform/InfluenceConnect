...
export default function AuthLayout({ children }: AuthLayoutProps) {
  return (
    <div className="min-h-screen bg-[#060D1A] flex flex-col relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none select-none" aria-hidden="true">
        ...
        <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="ic-dots" x="0" y="0" width="28" height="28" patternUnits="userSpaceOnUse">
              <circle cx="1.5" cy="1.5" r="1.5" fill="rgba(127,168,173,0.14)" />
            </pattern>
          </defs>
          <rect width="100%" height="100%" fill="url(#ic-dots)" />
        </svg>

        {/* Dark radial overlay so dots fade toward center */}
        <div
          className="absolute inset-0"
          style={{
            background: 'radial-gradient(ellipse 65% 65% at 50% 50%, rgba(6,13,26,0.82) 0%, rgba(6,13,26,0.28) 70%, transparent 100%)'
          }}
        />
        ...
        <div
          ...
          style={{
            background: 'radial-gradient(circle at center, rgba(93,138,143,0.55) 0%, rgba(93,138,143,0.2) 45%, transparent 70%)',
            filter: 'blur(80px)'
          }}
        />
        ...
        <div
          ...
          style={{
            background: 'radial-gradient(circle at center, rgba(61,80,135,0.6) 0%, rgba(61,80,135,0.2) 45%, transparent 70%)',
            filter: 'blur(88px)'
          }}
        />
        ...
        <div
          ...
          style={{
            background: 'radial-gradient(circle at center, rgba(127,168,173,0.32) 0%, transparent 65%)',
            filter: 'blur(64px)'
          }}
        />
        ...
        <div
          ...
          style={{
            background: 'radial-gradient(circle at center, rgba(61,80,135,0.2) 0%, transparent 65%)',
            filter: 'blur(64px)'
          }}
        />
        ...
        <svg
          className="absolute -top-16 -left-16 opacity-[0.07]"
        ...
        <svg
          className="absolute -bottom-20 -right-20 opacity-[0.07]"
        ...
        {/* Plus accent — right */}
        <svg className="absolute top-1/3 right-12 opacity-20" width="18" height="18" viewBox="0 0 18 18" fill="none">
        ...
        {/* Plus accent — left */}
        <svg className="absolute bottom-1/3 left-14 opacity-15" width="18" height="18" viewBox="0 0 18 18" fill="none">
        ...
        <svg className="absolute top-16 left-1/2 -translate-x-1/2 opacity-[0.1]" width="10" height="10" viewBox="0 0 10 10" fill="none">
        ...
        <div className="absolute top-1/2 left-8 w-1.5 h-1.5 rounded-full bg-[#5D8A8F] opacity-15" />
        <div className="absolute bottom-32 right-1/3 w-2 h-2 rounded-full bg-[#7FA8AD] opacity-15" />
        <div className="absolute top-1/4 left-1/3 w-1 h-1 rounded-full bg-[#7FA8AD] opacity-20" />
      </div>
      ...
      <header className="relative z-10 flex items-center justify-between px-8 py-5">
        <Link href="/" className="flex items-center gap-2.5 group">
          ...
          <span className="font-semibold text-slate-200 tracking-tight">Influence Connect</span>
        </Link>
      </header>
