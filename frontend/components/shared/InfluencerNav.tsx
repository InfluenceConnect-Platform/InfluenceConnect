...
export default function InfluencerNav({ user: userProp, profilePicUrl }: InfluencerNavProps) {
  ...
  const planTier = normalizeTier('influencer', (user as { tier?: string } | null)?.tier);
  const planName = tierLabel('influencer', planTier);
        ...
        <div className="flex items-center gap-2 sm:gap-2.5 flex-shrink-0">
          ...
          {user && (isPaid ? (
            <span className={`hidden sm:inline-flex items-center gap-1 text-[11px] font-bold px-2.5 py-1 rounded-full text-white shadow-sm ${
              planTier === 'platinum'
                ? 'bg-gradient-to-r from-violet-400 to-indigo-400 shadow-indigo-200'
                : planTier === 'golden'
          ...
          <Link
            ...
            className={`relative w-9 h-9 rounded-full overflow-hidden ring-2 shadow-sm transition-all duration-150 flex-shrink-0 flex items-center justify-center bg-gradient-to-br from-[#FCE4EC] to-[#F3B8CB] cursor-pointer
        ...
        <>
          ...
          <div className={`lg:hidden fixed top-[64px] left-0 right-0 z-20 border-b shadow-xl
            ...
            <div className="px-4 py-3 flex flex-col gap-1">
              ...
              >
                <span className={pathname === '/influencer/settings' ? activeIconCls : isDark ? 'text-slate-400' : 'text-gray-400'}>
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/>
                  </svg>
                </span>
