...
//
// Selection is two-step: pick a state/UT, then pick a city within it. Lists
// cover major cities/towns per state (district headquarters and above), not
// just the metros, per client feedback that the old lists were too short.
// City values already stored on old records (all metro names) are preserved
